...
[default-yaml]: /guide/file-structure#default-yaml
...
new format. See [the v4 release notes](/guide/upgrade-guide/v4.0).
...
directly on a host machine). The [Docker](/guide/installation/docker) page has troubleshooting steps as
well.
