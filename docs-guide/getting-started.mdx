...
Please make sure you've reviewed the various [installation methods](/guide/installation) before
...
[Installation Instructions](/guide/installation/docker)
...
If you're using [Cron Mode](/guide/installation/docker#cron-mode), your work ends here. If you want to
verify the behavior by [running manually](/guide/installation/docker#manual-mode), then you can execute
...
[Installation Instructions](/guide/installation/manual-install)
...
loaded](/guide/file-structure#default-yaml) and look at [examples of how to split your
files](/reference/config-examples)
