...
const FeatureList = [
  {
    ...
    icon: "mdi:sync",
    description:
      "Continuously synchronize custom formats, quality profiles, naming schemes, and more from TRaSH Guides",
  },
  {
    title: "Multi-Instance Management",
    icon: "mdi:server-network",
    description:
      "Configure and manage multiple Sonarr and Radarr instances from a single YAML file",
  },
  {
