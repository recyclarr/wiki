...
This guide walks you through setting up Recyclarr to sync [TRaSH Guide][trash-guides] quality
...
Generate a config file from your chosen template. For example, to use the [`HD Bluray +
WEB`][hd-bluray-web] profile:
...
- [Configuration Examples](../reference/config-examples.mdx) — Real-world configuration patterns
...
- [CLI Reference](../cli/index.mdx) — All commands and options
- [File Structure](./file-structure.mdx#config-directory) — Where Recyclarr stores data
