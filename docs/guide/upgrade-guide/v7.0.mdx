...
The [app data directory](../file-structure.mdx#config-directory) path has changed for only the MacOS
...
A migration step automatically moves the data directory for you when Recyclarr starts.
...
### Option 1: Stay on Recyclarr v6.0 {/*#option-1-stay-on-recyclarr-v60*/}
...
### Option 2: Upgrade your instances of Sonarr {/*#option-2-upgrade-your-instances-of-sonarr*/}
...
[ref]: ../../reference/configuration/index.mdx
