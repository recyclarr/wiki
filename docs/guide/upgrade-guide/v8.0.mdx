...
to the [`config` include directive](/reference/configuration/include#config) were rooted in
...
See the [Resource Providers](/reference/settings/resource-providers/) documentation for complete
