...
example](../../reference/config-examples.mdx#directory-structure) showing multiple configuration files
and their structure.
...
See the [until_quality reference](../../reference/configuration/quality-profiles.mdx#until-quality)
for more details.
