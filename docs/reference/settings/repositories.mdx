...
description: Deprecated; use Resource Providers instead
---
...
See the [v8.0 upgrade guide](../../guide/upgrade-guide/v8.0.mdx#resource-providers) for complete migration
instructions.
