...
| Property  | Required    | Description                                                        |
|-----------|-------------|--------------------------------------------------------------------|
| `path`    | Yes         | Path to the directory (absolute or relative to app data directory) |
...
Relative paths are resolved against the [app data directory][appdata]. This is useful for keeping
custom resources alongside Recyclarr's other data.
