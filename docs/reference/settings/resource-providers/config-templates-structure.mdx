...
The official repository no longer provides include templates as of v8 (its `includes.json` is
empty). The include examples on this page apply only to custom resource providers.
