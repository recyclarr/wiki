...
## Custom Format JSON Structure {/*#custom-format-json-structure*/}
...
## Quality Size JSON Structure {/*#quality-size-json-structure*/}
...
## Media Naming JSON Structure {/*#media-naming-json-structure*/}
...
## Category Organization (Optional) {/*#category-organization-optional*/}
