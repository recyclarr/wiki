...
### Sonarr Naming Example {/*#sonarr-naming-example*/}
...
### Radarr Naming Example {/*#radarr-naming-example*/}
...
The official config-templates repository no longer provides include templates as of v8. The examples
below apply only to custom resource providers that supply their own `includes.json`.

:::

### Adding Custom Includes {/*#adding-custom-includes*/}

Use unique IDs to define include templates in your custom resource provider:
...
### Overriding an Official Template {/*#overriding-an-official-template*/}
...
### Overriding an Official Custom Format {/*#overriding-an-official-custom-format*/}
...
### Adding New Custom Formats {/*#adding-new-custom-formats*/}
