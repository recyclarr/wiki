...
appear in the top-level [`quality_profiles` list][qps]; however, if you want Recyclarr to create it,
...
profiles. This is the only way to target a specific [profile variant][variants] when multiple
