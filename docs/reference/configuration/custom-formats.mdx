    ...
    custom_format_groups:
      ...
      add:
        ...
        - trash_id: 9d5acd8f1da78dfbae788182f7605200 # Customize Audio Formats
          select:
            - 7357cf5161efbf8c4d5d0c30b4815ee2 # Select specific CFs
```
...
group's behavior (e.g., specify `select` to change which CFs sync).
...
A list of CF trash IDs to select from this group. Only the listed CFs (plus required CFs) sync.

When a group contains mutually exclusive CFs, selecting a non-default CF automatically replaces the
default.
