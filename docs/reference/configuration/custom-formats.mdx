...
The trash ID of a [guide-backed quality profile][guide-qp]. The profile must be in the group's
include list, otherwise a validation error is reported.
...
assign group scores to custom (non-guide-backed) profiles. The profile must exist in your
