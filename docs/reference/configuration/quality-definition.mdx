...
Quality definitions control the minimum, maximum, and preferred file sizes for each quality level
(e.g., Bluray-1080p, WEBDL-720p). These size limits apply to the entire instance, shared by all
quality profiles. If not specified, quality definitions are not modified in the service.
