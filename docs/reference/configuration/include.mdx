...
The `assign_scores_to` and `exclude` properties use Replace rather than Add or Join. This provides
...
scores and which custom formats are excluded without needing to mentally combine multiple lists.
