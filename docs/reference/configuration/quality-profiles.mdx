...
**With `trash_id`:** The trash ID becomes the profile's identifier (tracked in Recyclarr's cache).
...
Quality profile trash IDs can be found in the TRaSH Guide JSON files under the
[`radarr/quality-profiles`][trashqp-radarr] or [`sonarr/quality-profiles`][trashqp-sonarr]
directories.

[trashqp-radarr]: https://github.com/TRaSH-/Guides/tree/master/docs/json/radarr/quality-profiles
[trashqp-sonarr]: https://github.com/TRaSH-/Guides/tree/master/docs/json/sonarr/quality-profiles
