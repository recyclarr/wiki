...
- [SQP-1 WEB (1080p) - Streaming Optimized][radarr-sqp-1-web-1080p-trash]
...
[radarr-sqp-1-web-1080p-trash]: https://trash-guides.info/SQP/1-web/
...
| [SQP-1 WEB (1080p) - Streaming Optimized](#sqp-1-web-1080p) |
...
```yml reference title="Copy this configuration into your own configuration file:"
https://github.com/recyclarr/config-templates/blob/master/radarr/templates/sqp/sqp-1-web-1080p.yml
```
