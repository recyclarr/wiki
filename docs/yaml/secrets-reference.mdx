...
[base_url]: /yaml/config-reference/basic.mdx#base-url
[api_key]: /yaml/config-reference/basic.mdx#api-key
[instance_name]: /yaml/config-reference/basic.mdx#instance-name
