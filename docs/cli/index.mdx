...
If you see a section title with a pipe character (`|`) in it, like `-c|--config`, that means that
option has both a short *and* long form. So you can specify `-c` or `--config`.
