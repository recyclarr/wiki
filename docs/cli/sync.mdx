...
Synchronizes the guide with various services. See [Sync Behavior][behavior] for details on how sync
works and how to interpret its output.

[behavior]: ../guide/sync-behavior.mdx
...
Structure](../guide/file-structure.mdx) page.
...
#### Command Line Examples {/*#command-line-examples-2*/}
