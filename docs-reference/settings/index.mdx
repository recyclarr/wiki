...
Resource providers control where Recyclarr downloads configuration data like custom formats and
templates. By default, official repositories are automatically included, so configuration is only
needed for custom sources.

See the [Resource Providers](./resource-providers/index.mdx) page for complete documentation.
