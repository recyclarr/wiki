...
| ---------------- | ------------------ | ---------------------------------- |
| Custom Formats   | `trash_id` field   | `adb69736c7c245bcb3661ad1c36ae6a3` |
| Quality Profiles | `trash_id` field   | `ebf5f3740e3d4e7a9e68c7e9c5f8a1d2` |
| Quality Sizes    | `type` field       | `series`, `movie`                  |
| Media Naming     | Dictionary key     | `default`, `no-episode-title`      |
| Config Templates | `id` field         | `radarr-sqp-1-1080p`               |
| Config Includes  | `id` field         | `radarr-cf-remux-web-1080p`        |
