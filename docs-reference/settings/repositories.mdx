...
Please migrate to [Resource Providers](./resource-providers/) for the new, more flexible system.
...
The new [Resource Providers](./resource-providers/) system replaces this deprecated format.
